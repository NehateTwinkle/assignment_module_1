...
public class hbutil {
	...
	public Session getsessiondata()
	{
		...
		pro.setProperty("hibernate.connection.url","jdbc:mysql://localhost:3306/onetoone");
		...
		cfg.addProperties(pro).addAnnotatedClass(Employee.class).addAnnotatedClass(ProfileDetails.class);
